...
public sealed record GetRosterComplianceConfigurationHistoryQuery(Guid VenueId) : IRequest<IReadOnlyList<RosterComplianceConfigurationDto>>, IVenueScopedRequest;
