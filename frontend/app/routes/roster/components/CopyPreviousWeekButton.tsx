        ...
        {previousWeek.isLoading ? (
          ...
          <Empty>
            <EmptyHeader>
              ...
              <EmptyDescription>
                There's no published roster for the week of {previousWeekLabel} yet for this
                venue.
              </EmptyDescription>
            </EmptyHeader>
          </Empty>
          ...
          <p className="text-sm text-muted-foreground">
            ...
            {shifts.length === 1 ? "shift" : "shifts"} from {previousWeekLabel} into this week
            {currentShiftCount > 0 && (
              <>
                , replacing the <strong className="text-foreground">{currentShiftCount}</strong>{" "}
                {currentShiftCount === 1 ? "shift" : "shifts"} already on this week's draft
              </>
            )}
            .
          </p>
          ...
          <DialogFooter>
            ...
            >
              ...
              Copy {shifts.length > 0 ? shifts.length : ""} {shifts.length === 1 ? "shift" : "shifts"}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
